import { c as create_ssr_component, d as compute_rest_props, f as spread, h as escape_object, e as escape, i as each, j as add_attribute, v as validate_component, m as missing_component } from "./ssr.js";
...
const Gallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="masonry svelte-6b2t9q"><div class="${["container svelte-6b2t9q", "hidden"].join(" ").trim()}" style="${"width: " + escape(width, true) + "px"}">${each(scaledImages, ({ index, ratio: ratio2, scaledHeight, scaledWidth, isLastInRow, isLastRow, scaledWidthPc, ...image }) => {
